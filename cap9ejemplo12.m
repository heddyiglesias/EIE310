%Ejemplo 12: el archivo  ups.txt  contiene 5400 muestras de la corriente [Amp] de la línea de 220 V
%entrando a una UPS (Uninterruptible Power Supply).  Fs: 6400 [m/s].
%El siguiente programa grafica la forma de onda y su espectro.
