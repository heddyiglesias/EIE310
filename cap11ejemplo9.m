...
close all;
clc;
%Ejemplo 9: diseñar un filtro pasabajos usando el método óptimo con las siguientes especificaciones: 
 %• Banda de paso: 0 a 0.2 c/m 
 %• Ripple (oscilaciones) en la banda de paso: 3 dB ptp 
 %• Banda de rechazo: 0.25 a 0.5 c/m 
 %• Atenuación mínima (o ripple) en la banda de rechazo: 40 dB 
