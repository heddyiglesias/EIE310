...
close all;
clc;
%Ejemplo 7: se diseña un filtro pasabajos ideal con los siguientes datos: 
 %• Frecuencia de corte   wc = ? /2  [rad/m] 
 %• Longitud de  h(n):   N = 33 
 
%El siguiente programa diseña el filtro y compara la respuesta de frecuencia deseada con la obtenida. 
